...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "1981280736").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "proud_kannadiga"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "proud_kannadiga")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1003866132187").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003187473140"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003955441666"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003889088978"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003889088978"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003889088978"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Kannadiga:jwp82BdKZxi3Ub7J@cluster0.u5j0byq.mongodb.net/?appName=Cluster0")
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003187473140"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003690398755")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003187473140"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/Kannada_Cineflix")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/Kannada_Cineflix_request")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", True)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+PQTSxS5vxeo5YzBl")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+PQTSxS5vxeo5YzBl")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/+PQTSxS5vxeo5YzBl")
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg"
)
SHORTENER_API = environ.get("SHORTENER_API", "ba1103ff3500b60d006da49756ebafff3b8f6550")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shortxlinks.com")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "2466063c23826f5a45b9418a8b5932b21820df08"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "nowshort.com")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "ba1103ff3500b60d006da49756ebafff3b8f6550"
)
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "shortxlinks.com")
TWO_VERIFY_GAP = int(environ.get("TWO_VERIFY_GAP", "2000"))
THREE_VERIFY_GAP = int(environ.get("THREE_VERIFY_GAP", "3000"))
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/4c392f18afa85ad2947f7-66ba07e7bb42fffbb2.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://graph.org/file/71f2a9a8a6219aa0cc670-0d6aca3754e7a37372.jpg")
).split()
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://defeated-selia-kfcinemas11-5c1847af.koyeb.app/")
